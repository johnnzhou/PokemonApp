...
//  PokeMaster
//
//  Created by Zhennan Zhou on 3/26/22.
        ...
        GeometryReader { proxy in
            ZStack {
                Hexagon(
                    ...
                    .animation(self.shouldAnimate ? Animation.linear(duration: 0.5) : nil)
                Hexagon(
                    values: self.values,
                    max: self.max,
                    progress: self.progress
                    ...
                    .animation(self.shouldAnimate ? Animation.linear(duration: 0.5).delay(0.2) : nil)
            }
            .frame(
